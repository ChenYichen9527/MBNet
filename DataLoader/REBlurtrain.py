...
class reblur_train(Dataset):
    ...
    def __getitem__(self, index):
        ...
        dt = ts_k-ts_0
        Im2= self.get_frame(k)
        Igt = self.get_gt_frame(k)
        ...
        frame = Im2[h_start:h_end, w_start:w_end, :]      
        frame_gt = Igt[h_start:h_end, w_start:w_end, :]
        ...
        eventpoints1 = np.stack([ ts, xs, ys, ps], 1)
        ...
        eventpoints = np.concatenate([eventpoints[:,0:1], x, y, p], 1)
