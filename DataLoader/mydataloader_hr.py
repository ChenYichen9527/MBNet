...
class Goprosataset_hr(Dataset):
    def __init__(self, data_root, is_training):
        ...
        self.gt_file = os.path.join(self.file_root, 'sharp_gray_hr')
    ...
    def __getitem__(self, index):
        ...
        time1 = self.imageslist[file_i][lines_i][0]
        time2 = self.imageslist[file_i][lines_i+2][0]
        ...
        img_gt = Igt[int(h_start*4) :int(h_end*4) , int(w_start*4) :int(w_end*4) , :]
